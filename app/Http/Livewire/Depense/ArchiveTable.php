...
final class ArchiveTable extends PowerGridComponent
{
    ...
    */
    ...
    public function datasource()
    {
        ...
        $depenses = Depense::where('archive', true)->orderBy('created_at', 'desc')->get();
    ...
    */
    ...
    public function actions(): array
    {
       return [
            ...
            ->bladeComponent('button-unarchive', function(Depense $depense) {
                return ['route' => route('depense.unarchive', Crypt::encrypt($depense->id)),
                'tooltip' => "Désarchiver",
                'classunarchive' => "unarchive_depense",
                'permission' => Gate::allows('permission', 'modifier-depense'),
