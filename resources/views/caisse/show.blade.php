                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('caisse.index') }}">Caisse</a></li>
                        </ol>
                    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row g-0">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-4 ">
                                    <a href="{{ route('caisse.index') }}" type="button" class="btn btn-outline-primary"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                    ...
                                                    <div class="container-titre">
                                                        ...
                                                        <div class="item-titre">
                                                            <!-- Product title -->
                                                            <span class="mt-0 ">{{$caisse->nature }} </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- Product description -->
                                                    <div class="mt-4">
                                                        <h6 class="font-14">Solde </h6>
                                                        <span class="badge bg-info text-white font-bold px-2 fs-5" >  {{ number_format($caisse->solde, 0, ',', ' ') }} FCFA </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <livewire:transaction.index-table :transactions="$caisse->transactions" >
...
@section('script')
    ...
    <script>
        var gerer_stock = @json($caisse->gerer_stock);
    ...
    <script>
        $('.edit-declinaison').click(function(e) {
            ...
            $('#edit_prix_caisse_ht_decli').val(that.data('prix_caisse_ht'));
            $('#edit_prix_caisse_ttc_decli').val(that.data('prix_caisse_ttc'));
            $('#edit_prix_caisse_max_ht_decli').val(that.data('prix_caisse_max_ht'));
            $('#edit_prix_caisse_max_ttc_decli').val(that.data('prix_caisse_max_ttc'));
            ...
            $('#edit_quantite_min_caisse_decli').val(that.data('quantite_min'));
