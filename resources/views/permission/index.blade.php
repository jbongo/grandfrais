                                        ...
                                        @foreach ($permissionsGroups as $group)
                                            ...
                                            @foreach ($group->permissions as $permission)
                                                <tr>
                                                    ...
                                                    <td> <label for="{{ $permission->id }}" style="cursor: pointer;"
                                                            class="text-body fw-bold">{{ $permission->description }}
                                                        </label> </td>
                                                    @foreach ($roles as $role)
                                                        <td>
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                @if ($role->havePermission($permission->id)) checked @endif>
                                                        </td>
                                                    @endforeach
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="description"
                                        value="{{ old('description') ? old('description') : '' }}" class="form-control"
                                        id="floatingInput">
                    ...
                    <form action="" method="post" id="form-edit">
                        <div class="modal-body">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="nom" value="{{ old('nom') ? old('nom') : '' }}"
                                        class="form-control" id="edit-nom">
...
@section('script')
    ...
    <script>
        $('.edit-role').click(function(e) {
            ...
            $('#edit-permissiongroup_id option[value=' + currentPermissiongroup_id + ']').attr('selected',
                'selected');
