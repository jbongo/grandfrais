                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex justify-content-end">
                                @can('permission', 'archiver-depense')
                                    <a href="{{ route('depense.index') }}" class="btn btn-success mb-2">
                                        <i class="mdi mdi-archive me-2"></i> Dépenses actives
                                    </a>
                                @endcan
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <livewire:depense.archive-table />
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        $(function() {
            ...
            $('[data-toggle="tooltip"]').tooltip()
            $('body').on('click', 'a.unarchive_depense', function(event) {
                let that = $(this)
                event.preventDefault();
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            .done(function() {
                                ...
                                swalWithBootstrapButtons.fire(
                                    'Confirmation',
                                    'Dépense desarchivée avec succès',
                                    'success'
                                )
                                document.location.reload();
